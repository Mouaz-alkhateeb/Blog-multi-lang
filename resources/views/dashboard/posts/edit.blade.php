...
@section('body')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ __('words.update post') }}</li>
    </ol>
                                    ...
                                    @foreach (config('app.languages') as $key => $lang)
                                        <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="{{ $key }}[small_desc]" class="form-control" id="editor" cols="50" rows="10">{{$post->translate($key)->small_desc}}</textarea>
                                            </div>
